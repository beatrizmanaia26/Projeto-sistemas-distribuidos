...
Todas as mensagens devem conter o timestamp do envio
As mensagens devem ser serializadas em binário usando algum formato conhecido (e.g., ProtoBuff, Apache Avro, Thrift, MessagePack, etc). Não podem ser envidas mensagens usando JSON, XML ou texto simples.
